...
void click::get_coordinate(int n, int *array_mine, bool *array_seen)
{
    ...
    if (x0 >= 0 && x0 < n && y0 >= 0 && y0 < n)
    {
        ...
        {
            whether_click_right(array_mine, array_seen);
        }
    }
}
...
int click::whether_click_left(int *array_mine, bool *array_seen)
{
    {
...
void click::whether_click_right(int *array_mine, bool *array_seen)
{
